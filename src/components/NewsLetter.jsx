...
const NewsLetter = () => {
  return (
    <div className='bg-[#283A61] w-full max-w-[382px] flex flex-col items-center text-center p-8 sm:p-12 rounded gap-5'>
      <h3 className='merriweather-font font-bold text-xl sm:text-2xl text-white'>
        Subscribe To Our Newsletter
      </h3>
      <p className='text-[#DFE6FF] roboto-font text-sm sm:text-base '>
      ...
      <button className='bg-[#000638] rounded w-[99px] text-sm sm:text-base text-white font-bold text-center px-4 py-2 cursor-pointer'>Sign Up</button>
    </div>
  )
}
